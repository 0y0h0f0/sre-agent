...
| RAG | Runbook chunk、FakeEmbedding、pgvector、BM25、reranker |
...
- Runbook 增强：BM25 混合检索、reranker、多语言 embedding 配置、草稿和版本。
- 记忆与学习：NFA 标记、跨事故关联、反馈数据。
- 协作：评论、证据标注、审批组、审计日志。
- Ops：API key 鉴权、Prometheus metrics、WebSocket 节点事件、shadow eval。
