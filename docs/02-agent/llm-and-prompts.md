...
| `openai` | `OpenAICompatibleAdapter` | 是 | 手动 full eval 或受控 M9 功能 |
| `deepseek` | `OpenAICompatibleAdapter` | 是 | 手动 full eval 或受控 M9 功能 |
| `anthropic` | `AnthropicAdapter` | 是 | 手动 full eval 或受控 M9 功能 |
